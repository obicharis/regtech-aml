...
async function seedRapidPassThrough() {
  const raw = fs.readFileSync('./data/rapidPassThrough.json', 'utf-8');
  ...
  try {
    ...
    console.log('Rapid pass-through pattern seeded successfully.');
  } catch (err) {
