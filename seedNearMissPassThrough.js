...
async function seedNearMissPassThrough() {
  const raw = fs.readFileSync('./data/nearMissPassThrough.json', 'utf-8');
  ...
  try {
    ...
    console.log('Near-miss pass-through pattern seeded successfully.');
  } catch (err) {
